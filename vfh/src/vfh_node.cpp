...
nh_(nh), nh_private_(nh_private)
{
	...
	m_sector_angle = 5;							// deg, sector angle
		...
		m_max_speed= 500;						// mm/sec, int, max speed


		m_max_speed_narrow_opening= 300; 		// mm/sec, int, max speed in the narrow opening


		m_max_speed_wide_opening= 400; 			// mm/sec, int, max speed in the wide opening

		m_max_acceleration = 400;    			// mm/sec^2, int, max acceleration
	...
	m_min_turn_radius_safety_factor = 1.0; 		// double ????
		...
		m_free_space_cutoff_0ms = 1000000.0; 	//double, low threshold free space at 0 m/s

		m_obs_cutoff_0ms = 2000000.0;			//double, high threshold obstacle at 0 m/s

		m_free_space_cutoff_1ms = 1000000.0; 	//double, low threshold free space at 1 m/s

		m_obs_cutoff_1ms = 2000000.0;			//double, high threshold obstacle at 1 m/s
...
void VFH_node::update()
{
	...
	geometry_msgs::Twist cmd_vel;
	cmd_vel.linear.x=(float)(chosen_speed)/100.0;
